...
public class GameViewer extends Viewer<Arena> {
    ...
    public void drawElements(GUI gui) {
        ...
        gui.drawText(new Position(5, 3), "Player 1: " + getModel().getPlayer_1().getLives() + " lives", "#FFD700");

        gui.drawText(new Position(54, 3), "Player 2: " + getModel().getPlayer_2().getLives() + " lives", "#FFD700");
    }
